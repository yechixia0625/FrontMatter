...
async def analyze_space(
    ...
    annual_rent_escalation: float = Form(0, ge=0, le=1),
    annual_revenue_growth: float = Form(0, ge=-1, le=1),
    turnover_rent_rate: float = Form(0, ge=0, le=1),
    opening_ramp_months: int = Form(3, ge=0, le=24),
    discount_rate_annual: float = Form(0.08, ge=0, le=1),
    ...
    try:
        intake = SpaceIntakeRequest(
            ...
            turnover_rent_rate=turnover_rent_rate,
            opening_ramp_months=opening_ramp_months,
